...
BOOK_SRC = r"i:\.m\.minecraft\versions\1.20.1-Forge_47.3.22\tcon\assets\tconstruct\textures\item\puny_smelting.png"
OUT = r"i:\.m\.minecraft\versions\1.20.1-Forge_47.3.22\thingpacks\Tinkers--Waste\assets\tinkers_waste\textures\item\guide.png"
...
book_img = Image.open(BOOK_SRC).convert("RGBA")
